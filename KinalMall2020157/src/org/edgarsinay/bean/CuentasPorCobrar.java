...
public class CuentasPorCobrar {
    ...
    public CuentasPorCobrar(int codigoCuentasPorCobrar, String numeroFactura, int anio, int mes, double valorNetoPago, String estadoPago, int codigoAdministracion, int codigoCliente, int codigoLocal) {
