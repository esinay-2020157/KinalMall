...
public class Proveedor {
    ...
    public Proveedor(int codigoProveedor, String NITProveedor, String servicioPrestado, String telefonoProveedor, String direccionProveedor, Double saldoFavor, Double saldoContra, Integer codigoAdministracion) {
